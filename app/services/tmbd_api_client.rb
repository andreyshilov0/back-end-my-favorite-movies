...
class GetTmbdApi
  ...
  def request_genres_movie
    response_genres = instance_request.get('genre/movie/list', { language: 'en-US' })
  ...
  def request_discover_movie(sort_by, page, with_genres, year, vote_avarege)
    response_data_movies = instance_request.get('discover/movie',
  ...
  def request_movie_by_id(id)
    response_data_movies_by_id = instance_request.get("movie/#{id}", { language: 'en-US' })
  ...
  def request_total_pages
    response_total_page_count = instance_request.get('discover/movie', { language: 'en-US' })
