class TmdbApi
  ...
  def self.genres_movie
    get_api_data('genre/movie/list')
  end

  def self.discover_movie(sort_by, page, with_genres, year, vote_average, popularity)
